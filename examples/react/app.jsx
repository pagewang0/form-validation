require.config({
  paths: {
    Validator: 'dist/form-validation',
    React: 'examples/react/node_modules/react/umd/react.development',
    react: 'examples/react/node_modules/react/umd/react.development',
    ReactDOM: 'examples/react/node_modules/react-dom/umd/react-dom.development',
    superagent: 'examples/react/node_modules/superagent/superagent',
    _validator: 'examples/react/node_modules/validator/validator'
  }
})

require(['react'], function (React) {
  require(['Validator', 'ReactDOM', 'superagent'], function (Validator, ReactDOM, superagent) {
    ...
    var validation = (state, setState) => {
      ...
      validator.path('email').validate(function (field, email, done) {
        require(['_validator'], function (_validator) {
